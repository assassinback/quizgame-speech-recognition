...
namespace quizgame {
	...
	public:
		DeleteUser(void)
		{
			...
			x->Rate = -2;
			x->SpeakAsync("Enter username then click on delete to delete user");
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(352, 152);
			...
			this->label2->Location = System::Drawing::Point(134, 114);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(244, 116);
