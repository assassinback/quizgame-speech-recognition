...
namespace quizgame {
	...
	/// <summary>
	/// Summary for DeleteQuestion
	/// </summary>
	public ref class DeleteQuestion : public System::Windows::Forms::Form
	{
	public:
		DeleteQuestion(void)
		{
			...
			x->Rate = -2;
			x->SpeakAsync("Enter question then click on delete to delete.");
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(DeleteQuestion::typeid));
			...
			this->button1->Location = System::Drawing::Point(352, 176);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(201, 41);
			this->button1->TabIndex = 0;
			this->button1->Text = L"DELETE QUESTION";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &DeleteQuestion::button1_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(239, 116);
			...
			this->Name = L"DeleteQuestion";
			this->Text = L"DeleteQuestion";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 y->Rate = -2;
				 y->SpeakAsync("Deleted!");
				 x.deletea(textBox1->Text);
	}
	};
}
