...
namespace quizgame {
	...
	/// <summary>
	/// Summary for SearchQuestion
	/// </summary>
	public ref class SearchQuestion : public System::Windows::Forms::Form
	{
	public:
		SearchQuestion(void)
		{
			...
			x->Rate = -2;
			x->SpeakAsync("Enter question the data of question will be displayed on the table");
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(SearchQuestion::typeid));
			...
			this->dataGridView1->Location = System::Drawing::Point(26, 35);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->ReadOnly = true;
			this->dataGridView1->Size = System::Drawing::Size(617, 139);
			...
			this->label1->Location = System::Drawing::Point(35, 213);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(170, 195);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(218, 59);
			...
			this->button1->Location = System::Drawing::Point(431, 201);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(177, 41);
			this->button1->TabIndex = 3;
			this->button1->Text = L"Search";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &SearchQuestion::button1_Click);
			// 
			// panel1
			// 
			...
			this->Name = L"SearchQuestion";
			this->Text = L"SearchQuestion";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 sqlconnect x;
				 x.searchquestion(textBox1->Text,dataGridView1,bindingSource1);
				 SpeechSynthesizer^ y = gcnew SpeechSynthesizer();
				 y->Rate = -2;
				 y->SpeakAsync("Searched!");
	}
	};
}
