...
namespace quizgame {
	...
	/// <summary>
	/// Summary for GiveQuiz
	/// </summary>
	public ref class GiveQuiz : public System::Windows::Forms::Form
	{
	String^ g="";
	int checkanswer = 0;
	int questionsdone = 0;
	...
	public:
		GiveQuiz(void)
		{
			...
			String^ y = gcnew String(x.head->question.c_str());
			label1->Text = y;
			String^ z = gcnew String(x.head->a.c_str());
			radioButton1->Text = z;
			String^ a = gcnew String(x.head->b.c_str());
			radioButton2->Text = a;
			String^ b = gcnew String(x.head->c.c_str());
			radioButton3->Text = b;
			String^ c = gcnew String(x.head->d.c_str());
			radioButton4->Text = c;
			SpeechSynthesizer^ p = gcnew SpeechSynthesizer();
			p->Rate = -2;
			int i = x.head->question.find("*");
			if (i == 0)
			{
				i = -1;
			}
			if (i > 0)
			{
				y = gcnew String(x.head->question.replace(i, 1, " Multiply by ").c_str());

			}
			i = x.head->question.find("/");
			if (i == 0)
			{
				i = -1;
			}
			if (i > 0)
			{
				y = gcnew String(x.head->question.replace(i, 1, " Divided by ").c_str());
			}
			p->SpeakAsync(y);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(GiveQuiz::typeid));
			...
			this->label1->Location = System::Drawing::Point(231, 52);
			...
			this->radioButton1->Location = System::Drawing::Point(184, 123);
			...
			this->radioButton2->Location = System::Drawing::Point(184, 162);
			...
			this->radioButton3->Location = System::Drawing::Point(417, 160);
			...
			this->radioButton4->Location = System::Drawing::Point(417, 120);
			...
			this->button1->Location = System::Drawing::Point(339, 205);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(177, 41);
			this->button1->TabIndex = 5;
			this->button1->Text = L"CONFIRM";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &GiveQuiz::button1_Click);
			// 
			// panel1
			// 
			...
			this->label10->Location = System::Drawing::Point(12, 137);
			...
			this->label9->Location = System::Drawing::Point(782, 137);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(23, 25);
			this->label9->TabIndex = 15;
			this->label9->Text = L"0";
			this->label9->Click += gcnew System::EventHandler(this, &GiveQuiz::label9_Click);
			// 
			// panel5
			// 
			...
			this->panel5->Location = System::Drawing::Point(734, 0);
			...
			this->label6->Location = System::Drawing::Point(26, 29);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(144, 62);
			...
			this->label2->Location = System::Drawing::Point(85, 55);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(143, 20);
			this->label2->TabIndex = 0;
			this->label2->Text = L"YOUR QUESTION";
			// 
			// label3
			// 
			...
			this->label3->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(39)), static_cast<System::Int32>(static_cast<System::Byte>(169)),
				static_cast<System::Int32>(static_cast<System::Byte>(225)));
			this->label3->Location = System::Drawing::Point(85, 122);
			...
			this->label4->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(39)), static_cast<System::Int32>(static_cast<System::Byte>(169)),
				static_cast<System::Int32>(static_cast<System::Byte>(225)));
			this->label4->Location = System::Drawing::Point(335, 122);
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &GiveQuiz::timer1_Tick);
			// 
			// GiveQuiz
			// 
			...
			this->Name = L"GiveQuiz";
			this->Text = L"GiveQuiz";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 if (x.head==NULL)
				 {
					 p->SpeakAsync("Your quiz is finished, Thank you "+n);
					 ...
					 {
						 difficu = "Random";
						 x.insertquizinfo(g, n, difficu);
						 goto label;
					 }
					 x.insertquizinfo(g,n,diffi);
					 label:
					 this->Hide();
				 }
				 else if (x.head != NULL)
				 {
					 ...
					 if (x.head != NULL)
					 {
						 String^ q = gcnew String(x.head->question.c_str());
						 label1->Text = q;
						 String^ z = gcnew String(x.head->a.c_str());
						 radioButton1->Text = z;
						 String^ a = gcnew String(x.head->b.c_str());
						 ...
						 if (i > 0)
						 {
							 q = gcnew String(x.head->question.replace(i, 1, " Multiply by ").c_str());
						 }
						 i = x.head->question.find("/");
						 if (i == 0)
						 {
						 ...
						 if (i > 0)
						 {
							 q = gcnew String(x.head->question.replace(i, 1, " Divided by ").c_str());
						 }
						 p->SpeakAsync(q);
					 }
					 else
